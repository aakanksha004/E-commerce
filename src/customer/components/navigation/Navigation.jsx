...
// import { navigation } from "src/customer/components/navigation/navigationdata.js"
    ...
    <div className="bg-white pb-10">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-gray-500 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over Rs1599
        </p>
{/* NAVBAR  */}
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                open
                                  ? "border-white text-gray-200 font-bold"
